...
def web_scrap(SECTION, number, PRICE, COLOR=None):
    ...
    :return: This function use the html of the main page, get into the page of chosen product (DRESSES, TOPS, SWIMWEAR)
    and the user's choices: number of products, max price and color of product.
